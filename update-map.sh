...
$IDP --read-pbf /var/data/mapdata/belgium-latest.osm.pbf --pr --create-routerdb --elevation vehicles=/var/data/mapdata/bicycle.lua --contract "bicycle" --contract "bicycle.shortest" --contract "bicycle.balanced" --contract "bicycle.networks" --contract "bicycle.brussels" --contract "bicycle.relaxed" --write-routerdb belgium.routerdb
